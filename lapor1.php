                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td class="truncate"><?= $row[4] ?></td> <!--foto-->
                        <td>
...
<div class="modal fade" id="editLapor" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="form-horizontal" action="lapor1.php" method="post">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            ID Pengaduan :<input type="text" class="form-control" name="id_pengaduan" id="id_pengaduan" readonly autocomplete="off" autofocus style="color: black;" >
            </div>
            <div class="form-group">
            Isi Laporan :<input type="text" class="form-control" name="isi_laporan" id="isi_laporan" rows="5" placeholder="Silahkan edit laporan anda" autocomplete="off" required style="color: black;">
            </div>
          </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="lapor1.php" method="POST" id="deleteForm">
