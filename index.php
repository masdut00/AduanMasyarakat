			...
			<div class="row">
				...
				<div class="col-md-offset-2 col-md-8 col-sm-12">
					<div class="home-thumb">
						<h1 class="wow fadeInUp" data-wow-delay="0.4s">Selamat Datang <?php echo $_SESSION['nama'] ?></h1>
						<h3 class="wow fadeInUp" data-wow-delay="0.6s">Ajukan laporan <strong> yang anda ketahui</strong> agar bisa <strong>kami tindak lanjuti</strong> </h3>
						<?php
						if (isset($_SESSION['nik'])) {
						?>
						...
						<div class="contact-form wow fadeInUp" data-wow-delay="1.0s">
							<form id="contact-form" method="post" action="index.php" enctype="multipart/form-data">
								...
								<div class="col-md-12 col-sm-12">
									<textarea name="isi_laporan" class="laporan" placeholder="Apa yang ingin Anda laporkan?" rows="6" required></textarea>
								</div>
